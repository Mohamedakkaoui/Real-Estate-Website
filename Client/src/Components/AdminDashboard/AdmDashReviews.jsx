...
export function ReviewsTable() {
  ...
  return (
    <>
    {!tableRows.length == 0 ? <Card className="h-full w-full">
                  ...
                  <tr key={index}>
                    ...
                    <td className={classes}>
                      <div className="flex items-center gap-4">
                        <Avatar
                          src={
                            owner.ProfilePic ? owner.ProfilePic : defaultAvatar
                          }
                          alt={name}
                          size="8"
                        />
      ...
      <CardFooter className="flex items-center justify-between border-t border-blue-gray-50 p-4">
        ...
        <div className="flex gap-2">
          <Button variant="outlined" size="sm" onClick={handlePrevPage} disabled = {curentPage == 1}>
            Previous
          </Button>
          <Button variant="outlined" size="sm" onClick={handleNextPage} disabled ={curentPage == totalPages}>
            Next
          </Button>
        </div>
      </CardFooter>
    </Card> : <div>no review yet</div>}
    </>
  );
}
