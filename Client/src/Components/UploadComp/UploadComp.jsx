    ...
    const itemTemplate = (file, props) => {
        return (
            <div className="flex flex-col items-center flex-wrap">
                ...
                <Button type="button" icon="pi pi-times" className="p-button-outlined p-button-rounded p-button-danger mx-auto my-auto" onClick={() => onTemplateRemove(file, props.onRemove)} />
            </div>
        );
    };
