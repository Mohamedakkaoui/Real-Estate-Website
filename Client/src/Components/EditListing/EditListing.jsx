        ...
        <div className="custom-form">
          <form onSubmit={handleSubmit}>
            ...
            <div className="widget">
              ...
              <div
                className="widget-content py-3 mb-2"
                style={{ borderTop: "1px solid #ccc" }}
              >
                <div className="grid grid-cols-5 gap-2 mx-5 ">
                  {images.map((image, index) => (
                    <div
                      key={index}
                      className="relative rounded-md group h-[200px]"
                    >
                      <img
                        className="group-hover:brightness-50 rounded-md h-[200px]"
                        src={image.url}
                        alt={"image House"}
                      />
                      <button
                        onClick={() => handlePicDelete(index)}
            ...
            <div className="widget pb-2">
              ...
              >
                <div className="flex gap-4 flex-wrap justify-between ml-3 mr-3">
                  <div
                    className="flex flex-col gap-4 w-2/5 mr-4"
                    style={{ width: "40%" }}
                  >
                    {" "}
                    {/* Left section with 40% width */}
                    <div>
                      <label
                        htmlFor="email"
                  ...
                  <div className="w-3/5" style={{ width: "55%" }}>
                    {" "}
                    {/* Right section takes the remaining width */}
                    <label
                      htmlFor="email"
                      className="block text-sm text-gray-600 mb-1"
                    >
                  ...
                  >
                    {" "}
                    {/* Third section with full width and flex-wrap */}
                    <label
                      htmlFor="amenities"
                      className="block text-sm text-gray-600 mb-1"
                    >
            ...
            <div className="flex justify-center mb-2">
              <button
                type="submit"
                className="bg-green-300 hover:bg-gray-400 text-white font-bold py-2 px-4 rounded inline-flex items-center"
