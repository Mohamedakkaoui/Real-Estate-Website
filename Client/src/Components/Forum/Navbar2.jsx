            ...
            >
                <section className="relative mx-auto">
                    ...
                    <nav className="flex  w-screen ">
                        <div className=" px-3 py-6 flex w-full ">
                            ...
                            <div className="flex-start w-full">
                                ...
                                {isSidebarOpen && (
                                    <div className="fixed top-0 left-0 w-64 h-full bg-white shadow-lg z-50">
                                        <button onClick={toggleSidebar} className="p-2 text-gray-600 text-2xl">
                                            ✖
                                        </button>
                                        <ul className="px-4 font-semibold font-heading space-y-4 mt-4">
                                            <li>
                                            ...
                                            <li>
                                                <Link to="/Properties" className="text-black hover:text-[#FFA920]" onClick={toggleSidebar}>
                                                    Properties
                                                </Link>
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                                <Link to="/About" className="text-black hover:text-[#FFA920]" onClick={toggleSidebar}>
                                                    About Us
                                                </Link>
                                            </li>
                                        </ul>
                            ...
                            <a className="flex justify-center items-center w-full  h-full" href="/Home">
