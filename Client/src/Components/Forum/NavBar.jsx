          ...
          <nav className="flex justify-between w-screen ">
            <div className="px-5 xl:px-12 py-6  flex w-full items-center">
              ...
              <ul className="hidden md:flex px-4 mx-auto font-semibold font-heading space-x-9">
                ...
                <li className="mt-2">
          <Link to="/Properties?status=buy" className="hover:text-[#FFA920]">
            Buy
          </Link>
        </li>
        <li className="mt-2">
          <Link to="/Properties?status=rent" className="hover:text-[#FFA920]">
            Rent
          </Link>
        </li>
        <li className="mt-2">
          <Link to="/Properties?status=vacation" className="hover:text-[#FFA920]">
            vacation
          </Link>
        </li>
                <li className="mt-2">
