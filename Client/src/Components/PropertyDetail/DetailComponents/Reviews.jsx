...
import RanyaImg from '../../../assets/ranyaph.jpeg'
  ...
  return (
    <div className="bg-white shadow-lg shadow-t-xl rounded-lg overflow-hidden border p-4 mt-10 mb-10">
      ...
      <div className="mt-3 w-[95%] m-auto">
        <article class="md:gap-8 md:flex md:grid-cols-3 pb-5 border-b-2">
          <div className="w-[30%]">
            <img className="rounded-lg " src={YassineImg} alt=""></img>
          </div>
          <div class="col-span-2 mt-6 md:mt-0">
            ...
            <p class="mb-2 text-gray-500 dark:text-gray-400">
              ...
              I highly recommend this accommodation for anyone visiting New York
              city centre.
            </p>
          </div>
        </article>
        <article class="md:gap-8 md:flex md:grid-cols-3 pb-5 border-b-2 mt-3">
          <div className="w-[30%]">
            <img className="rounded-lg " src={RanyaImg} alt=""></img>
          </div>
          <div class="col-span-2 mt-6 md:mt-0">
            <div class="flex items-start mb-2">
              <div class="pe-4">
                <footer>
                  <p class="mb-2 text-sm text-gray-500 dark:text-gray-400">
                    Reviewed:{" "}
                    <time datetime="2022-01-20 19:00">January 19, 2022</time>
                  </p>
                </footer>
                <h4 class="text-xl font-semibold text-gray-900 dark:text-white">
                  Ranya laasri
        ...
        <article class="md:gap-8 md:flex md:grid-cols-3 pb-5  mt-3">
          <div className="w-[30%]">
            <img className="rounded-lg " src={ZinebImg} alt=""></img>
          </div>
          <div class="col-span-2 mt-6 md:mt-0">
            <div class="flex items-start mb-2">
              <div class="pe-4">
                <footer>
                  <p class="mb-2 text-sm text-gray-500 dark:text-gray-400">
                    Reviewed:{" "}
                    <time datetime="2022-01-20 19:00">October 03, 2024</time>
                  </p>
                </footer>
                <h4 class="text-xl font-semibold text-gray-900 dark:text-white">
                  Zineb Laabdi
