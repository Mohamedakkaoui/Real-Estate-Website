...
function FavsCard({ property }) {
    const defaultimage = 'https://static.vecteezy.com/system/resources/previews/026/632/768/non_2x/image-icon-symbol-design-illustration-vector.jpg'
    return (
        <div className='w-1/3' style={{ margin: 'auto', width: '31%' }}>
            <div className="flex mb-10">
                <div className="listing-card-one rounded-lg h-100 w-full bg-white" style={{ boxShadow: '0px 4px 6px rgba(0, 0, 0, 0.1), 0px 8px 12px rgba(0, 0, 0, 0.1)' }}>
                    ...
                    <div className="property-info" style={{ padding: "10px 25px", maxWidth: '450px' }}>
                        <a className="text-black font-semibold" href={`/property/${property._id}`} style={{ fontSize: '22px' }}>{property.title}</a>
